...
import type { Evaluation, Application, Vacancy } from "@prisma/client";
...
async function generatePdf(evaluation: EvaluationWithRelations) {
  ...
  const ds = (rawScores || {}) as DetailedScores;
  ...
  console.log('Parsed ds.technologicalSkills:', JSON.stringify(ds.technologicalSkills, null, 2));
  console.log('============================');
