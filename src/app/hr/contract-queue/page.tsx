...
export default function ContractQueuePage() {
  ...
  const handleDownloadPdf = async (evaluation: Evaluation) => {
    try {
      ...
      const applicantName = evaluation.application?.fullName || "Applicant";
      a.href = url;
      a.download = `${applicantName.replace(
        /\s+/g,
        "_"
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex flex-col gap-2 ml-4 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg font-medium border border-gray-300 text-gray-700 hover:bg-gray-50 whitespace-nowrap"
                      >
                        Download PDF
                      </button>
